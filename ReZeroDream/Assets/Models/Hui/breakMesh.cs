...
public class breakMesh : MonoBehaviour
{
    ...
    private void DestroyMesh()
    {
        ...
        for (var c = 0; c < CutCascades; c++)
        {
            for (var i = 0; i < parts.Count; i++)
            {
                ...
                var plane = new Plane(UnityEngine.Random.onUnitSphere, center);
    ...
    private PartMesh GenerateMesh(PartMesh original, Plane plane, bool left)
    {
        ...
        for (var i = 0; i < original.Triangles.Length; i++)
        {
            ...
            for (var j = 0; j < triangles.Length; j = j + 3)
            {
                ...
                if (sideCount == 3) //가상의 면을 기준으로 그 면의 노멀 방향쪽에 있어야하며, 삼각형의 모든 vertex가 존재하는 경우, 그 삼각형을 나눔.
                {
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(breakMesh original, bool addScript)
        {
