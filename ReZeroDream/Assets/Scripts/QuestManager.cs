...
public class QuestManager : MonoBehaviour
{
    ...
    {   //이 부분 세부 목록 내용 수정 필요
        ...
        questList.Add(40, new QuestData("멈춰버린 도시에\n대해 알아보기", new int[] { 3000, -10000, 3000 }, //일단 대화 뜨면 안되니까 
            new string[] { "","아까 떨어지면서 옥상에서 무언가를 본 것 같다. 옥상 위를 확인해 이 멈춰버린 도심 속 놀이공원에 대한 단서를 얻어보자.", "옥상에서 내려가 주변을 둘러보며 도화지의 그림에 대한 단서를 얻어보자." },
            new string[] { "","내용: 옥상 위 확인하기", "내용: 주변 둘러보기" },
            new string[] { "", " ", "" }));
        ...
        new string[] { "즐거웠던 기억을 모두 찾으니 새로운 지역에 도착했다. 주변을 둘러보며 이 시간이 멈춘 등굣길에 대한 단서를 얻어보자.", "도화지를 획득했더니 주변의 군중들이 움직이기 시작한다. 이 사람들과 도화지 속 그림은 어떤 의미일까? 등굣길을 걸으며 알아보자." }, 
        new string[] { "내용: 주변 둘러보기", "내용: 등굣길 걷기" }, new string[] { " ", " " }));

        questList.Add(90, new QuestData("등굣길 걷기", new int[] {16000, 17000, 18000, 19000, 20000, 21000 },
        new string[] { "등굣길을 걸으며 멈춰있는 학생들에게 대화를 걸어보자.", "등굣길을 걸으며 멈춰있는 학생들에게 대화를 걸어보자.", "등굣길을 걸으며 멈춰있는 학생들에게 대화를 걸어보자.", "등굣길을 걸으며 멈춰있는 학생들에게 대화를 걸어보자.", "등굣길을 걸으며 멈춰있는 학생들에게 대화를 걸어보자.", "등굣길을 걸으며 멈춰있는 학생들에게 대화를 걸어보자." }, 
        new string[] { "내용: 학생들과 대화하기", "내용: 학생들과 대화하기", "내용: 학생들과 대화하기", "내용: 학생들과 대화하기", "내용: 학생들과 대화하기", "내용: 학생들과 대화하기" }, new string[] { " ", " ", " ", " ", " ", "보상: 과거에 대한 기억\n    '슬픔'" }));
        ...
        questList.Add(110, new QuestData("퀘스트 끝", new int[] { -10000 },
