...
public class QuestManager : MonoBehaviour
{
    ...
    {   //이 부분 세부 목록 내용 수정 필요
        ...
        questList.Add(20, new QuestData("???에 대해 알아보기", new int[] { 1000, 3000, 3000, 2000, 1000 },
            new string[] { "알 수 없는 말을 하는 소녀이다. 소녀에게 다시 한 번 더 대화를 걸어 단서를 얻자.", "주변을 둘러보고 오자.", "주변을 둘러보고 오자.", "주변을 둘러보고 오자.", "마치 도화지 같은 종이를 획득했다. 다시 소녀에게 돌아가보자." },
            new string[] { "???와 대화하기", "도화지 획득하기", "도화지 획득하기", "고양이와 상호작용하기", "???와 대화하기" },
            new string[] { " ", "도화지", "도화지", "고양이에 대한 기억", "" }));
        ...
        questList.Add(100, new QuestData("가족들과의 대화, 사랑", new int[] { 3000 },
