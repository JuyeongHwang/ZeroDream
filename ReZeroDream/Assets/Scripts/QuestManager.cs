...
public class QuestManager : MonoBehaviour
{
    ...
    void GenerateQuestData()
    {
        ...
        //몬스터 발견하면 퀘스트 아이디 50되도록, 구슬 획득하면 60 되도록

        questList.Add(50, new QuestData("위험한 존재에 대해 알아보기", new int[] { 3000, -10000 }, 
            new string[] { "희가 말했던 위험한 존재와 조우했다. 위험한 존재가 지키고 있는 구슬을 가져와 보자.", "희가 말했던 위험한 존재와 조우했다. 위험한 존재가 지키고 있는 구슬을 가져와 보자." },
            new string[] { "구슬 획득하기", "구슬 획득하기" },
            new string[] { "구슬 \n메모장의 새로운 페이지 활성화", "구슬 \n메모장의 새로운 페이지 활성화" }));

        questList.Add(60, new QuestData("메모장 채워보기", new int[] { 12000, 13000, 14000 },
            new string[] { "메모장에 알 수 없는 글자들이 있다. 관련된 기억들을 찾아보자.", "메모장에 알 수 없는 글자들이 있다. 관련된 기억들을 찾아보자.", "메모장에 알 수 없는 글자들이 있다. 관련된 기억들을 찾아보자." },
            new string[] { "여행과 관련된 것들 조사하기 \n배고픔 채우기", "여행과 관련된 것들 조사하기 \n배고픔 채우기", "여행과 관련된 것들 조사하기 \n배고픔 채우기" },
            new string[] { "여행 사진, ■■에 대한 단서 \n다음 지역 잠금 해제", "여행 사진, ■■에 대한 단서 \n다음 지역 잠금 해제", "여행 사진, ■■에 대한 단서 \n다음 지역 잠금 해제" }));

        questList.Add(70, new QuestData("메모장 채워보기", new int[] { 3000, 13000, 14000 },
            new string[] { "메모장에 알 수 없는 글자들이 있다. 관련된 기억들을 찾아보자.", "메모장에 알 수 없는 글자들이 있다. 관련된 기억들을 찾아보자.", "메모장에 알 수 없는 글자들이 있다. 관련된 기억들을 찾아보자." },
            new string[] { "여행과 관련된 것들 조사하기 \n배고픔 채우기", "여행과 관련된 것들 조사하기 \n배고픔 채우기", "여행과 관련된 것들 조사하기 \n배고픔 채우기" },
            new string[] { "여행 사진, ■■에 대한 단서 \n다음 지역 잠금 해제", "여행 사진, ■■에 대한 단서 \n다음 지역 잠금 해제", "여행 사진, ■■에 대한 단서 \n다음 지역 잠금 해제" }));
