...
public class QuestManager : MonoBehaviour
{
    ...
    {   //이 부분 세부 목록 내용 수정 필요
        ...
        questList.Add(20, new QuestData("???에 대해 알아보기", new int[] { 1000, 3000, 3000, 2000, 1000 },
            ...
            new string[] { " ", "두루마기", "두루마기", "고양이에 대한 기억", "" }));

        questList.Add(30, new QuestData("???을 찾아보기", new int[] { 10000, 11000, 1000 },
            new string[] { "내가 좋아했던 것들에는 무엇이 있었을까? 주변을 둘러보며 찾아보자.", "내가 좋아했던 것들에는 무엇이 있었을까? 주변을 둘러보며 찾아보자.", "좋아하던 꽃에 대한 기억이 떠오른다. 소녀, 희를 찾아가 그 사실을 말해보자." },
            new string[] { "주변 둘러보기", "주변 둘러보기", "희와 대화하기" }, 
            new string[] { " ", " ", "온전해진 메모장의 첫 페이지\n다음 지역 잠금 해제" }));
        ...
        //몬스터 발견 > questId == 50
        //구슬 획득 > questId == 60, 햄버거집 barrier 없어짐
        ...
        questList.Add(50, new QuestData("위험한 존재에 대해 알아보기", new int[] { 3000, -10000 }, 
            ...
            new string[] { "두루마기 획득하기", "두루마기 획득하기" },
            new string[] { "메모장의 새로운 페이지 활성화", "메모장의 새로운 페이지 활성화" }));

        questList.Add(60, new QuestData("메모장 채우기", new int[] { 12000, 13000, 14000 },
            new string[] { "메모장에 알 수 없는 글자들이 있다. 즐거웠던 기억들을 찾아보자.", "메모장에 알 수 없는 글자들이 있다. 즐거웠던 기억들을 찾아보자.", "메모장에 알 수 없는 글자들이 있다. 즐거웠던 기억들을 찾아보자." },
