...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(22 + 3000, new string[] { "그림이 그려져있어. 이 종이는 어디에 사용하는거지? :1" });
        ...
        talkData.Add(80 + 3000, new string[] { "여기는 또 어딜까?:1", "으스스해... 날씨도 흐리고, 온통 흑백에 시간이 멈춰있어.:1", "윽, 저 사람들은 얼굴이 없잖아?:1", "저 사이에 아까 그 도화지가 또 있네. 한 번 확인해보자.:1" });
        talkData.Add(81 + 3000, new string[] { "도화지를 획득하니 사람들이 움직이기 시작했어!:1", "이 그림은 또 무슨 의미일까?\n 어린 아이의 그림 같은데... 잘 보이지 않아.:1", "일단 등굣길을 걸어보자. 걷다보면 뭐든 나오겠지.:1" });
        ...
        talkData.Add(94 + 20000, new string[] { "이번에도 혼자네...:1", "함께 축구를 하던 친구들은 어디로 간 걸까?:1", "그런데 저 모습이 왜이렇게 익숙하지?:1" });
        talkData.Add(95 + 21000, new string[] { "맞아... 올해의 내 생일파티는 이랬었지.:1", "아무도 오지 않았고, 초대할 친구조차 없었어:1", "울고 있는 저 소년도, 친구들과 놀며 즐거워하던 소년도\n모두 '나'구나.:1", "어느날 갑자기 아무 이유 없이\n점점 소외당하고 무시당하던 '나'...:1", "이제 다 기억났어.:1" });
        ...
        //talkData.Add(100 + 5000, new string[] { "아까 그 애잖아. 왜 혼자있는 걸까?:1", "뒷모습이 슬퍼보여.\n왠지 나까지 외로워지는 기분이야.:1" });
        //talkData.Add(100 + 6000, new string[] { "이번에도 혼자네...:1", "함께 축구를 하던 친구들은 어디로 간 걸까?:1", "그런데 저 모습이 왜이렇게 익숙하지?:1" });
        //talkData.Add(100 + 7000, new string[] { "맞아... 올해의 내 생일파티는 이랬었지.:1", "아무도 오지 않았고, 초대할 친구조차 없었어:1", "울고 있는 저 소년도, 친구들과 놀며 즐거워하던 소년도\n모두 '나'구나.:1", "어느날 갑자기 아무 이유 없이\n점점 소외당하고 무시당하던 '나'...:1", "이제 다 기억났어.:1" });
