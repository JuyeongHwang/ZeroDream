...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(34 + 1000, new string[] { "후후, 본래의 색을 되찾았을 뿐이야.:2", "아쉽지만 이젠 다음으로 나아가야 할 시간이야.:2", "몬스터에 대한 설명 어쩌고저쩌고:2", "너라면 잘 해낼 수 있을 거야.:2", "난 언제나 너와 함께하고 있으니, 앞으로는 날 잊지 말아줘.:2"});
        
        talkData.Add(40 + 3000, new string[] { "분위기가 달라졌어.:1"});
        talkData.Add(50 + 3000, new string[] { "바뀐 몬스터 설명 어쩌고저쩌고:1" });
