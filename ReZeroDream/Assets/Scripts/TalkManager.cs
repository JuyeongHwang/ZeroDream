...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(80 + 3000, new string[] { "여기는 또 어딜까?:1", "으스스해... 날씨도 흐리고, 온통 흑백에 시간이 멈춰있어.:1", "윽, 저 사람들은 얼굴이 없잖아?", "저 사이에 아까 그 도화지가 또 있네. 한 번 확인해보자.:1" });
        talkData.Add(81 + 3000, new string[] { "도화지를 획득하니 사람들이 움직이기 시작했어!:1 ", "이 그림은 또 무슨 의미일까?\n 어린 아이의 그림 같은데... 잘 보이지 않아.", "일단 등굣길을 걸어보자. 걷다보면 뭐든 나오겠지.:1" });
