...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(40 + 3000, new string[] { "분위기가 달라졌어. \n여기는 도시가 멈춰있는 것 같아.:1", "떨어지면서 저 건물 옥상에서 무언가를 본것같아.\n확인해볼까?:1" });
        talkData.Add(50 + 3000, new string[] { "저건 뭐지?:1","이상한 생명체가 돌아다니고 있어.:1","무언가를 지키고 있는 것 같아.\n하지만 날 공격할것같지는 않아..:1" ,"저 발판은 뭐지. 한번 밟아볼까?:1" });
