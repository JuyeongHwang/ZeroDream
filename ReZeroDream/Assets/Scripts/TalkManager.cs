...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(24 + 1000, new string[] { "나를 찾아왔구나.:2", "기분이 좋아지지 않니?:2", "아직은 부족해 보이네. 날 조금 더 찾아와줘.:2", "너가 좋아했던 것들을 떠올려봐.\n주변을 둘러보면 발견할 수 있을 거야.:2", "너가 원하는 곳은 어디든 갈 수 있어.:2" });

        
        talkData.Add(30 + 10000, new string[] { "이건… 아닌 거 같아.:1" });
        talkData.Add(30 + 11000, new string[] { "익숙하고, 좋은 향기가 나... 지켜보는 것만으로도 좋아져...:1" });
        //약간... 희가 이젠 나에 대해 조금 알겠어? 맞아, 내 이름은 희야. 앞으로는 날 기억해줘. 이런 식으로 말하느 ㄴ대사 추가해도 괜찮을 것 같음...
        ...
        talkData.Add(60 + 14000, new string[] { "뭐지? 이 차는 뭔가 익숙해.:1", "그러고보니 예전에 가족들과 함께 이 차를 타고 바다로 여행을 갔었지.:1", "그때 보았던 바다가 정말 예뻤었는데...:1" }); //이름 일단 제로로 (제로가 말한 것처럼 나와야 하니까)
        ...
        talkData.Add(72 + 4000, new string[] { "미안하지만 더이상 햄버거는 팔 수 없어.\n이미 재료가 다 떨어졌거든.:3", "뭐, 정 배고프다면 주변에서 직접 찾아봐.\n너라면 그 햄버거를 얻을 수 있을지도...:3", "만약 햄버거를 얻어오면 자리와 음료 정도는 제공해 줄게.:3" });
        //뭔가... 햄버거 = 즐거움이니까 제로가 학교폭력 때문에 더이상 즐겁지 않다는 얘기로 해석할 수도 있을 것 같아서 대사를 이런 식으로 적어보았습니닷
        talkData.Add(73 + 15000, new string[] { "햄버거가 작아졌어! 딱 먹기 좋은 크기인 걸?:1", "이게 엔조가 말했던 '그 햄버거'일까? 가져가서 물어보자.:1"  });
